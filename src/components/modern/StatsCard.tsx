...
export default function StatsCard() {
    return (
        <div className="w-full grid grid-cols-3 gap-2 md:gap-6 py-4 px-0">
            <motion.div
            ...
            >
                <span className="text-3xl sm:text-4xl md:text-6xl font-bold text-white mb-2">+3</span>
            ...
            <motion.div
                ...
                className="flex flex-col"
            >
                <span className="text-3xl sm:text-4xl md:text-6xl font-bold text-white mb-2">+50</span>
            ...
            <motion.div
                ...
                className="flex flex-col"
            >
                <span className="text-3xl sm:text-4xl md:text-6xl font-bold text-white mb-2">+15</span>
